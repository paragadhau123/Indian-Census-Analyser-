...
public class CensusAnalyserTest {
    ...
    private static final String INDIA_CENSUS_CSV_FILE_PATH_WITH_WRONG_HEADER = "./src/test/resources/IndiaStateCensusDataWrongHeader.csv";
    private static final String INDIA_CENSUS_CSV_FILE_PATH_WITH_WRONG_DELIMETRE = "./src/test/resources/StateDataWrongDelimetre.csv";
    private static final String WRONG_CSV_FILE_PATH = "./src/main/resources/IndiaStateCensusData.csv";
    private static final String WRONG_FILE_TYPE = "./src/test/resources/IndiaStateCensusData.hkkhki";
    private static final String STATE_CODE_CSV_FILE_PATH = "./src/test/resources/IndiaStateCode.csv";
    private static final String STATE_CODE_CSV_FILE_PATH_WITH_WRONG_HEADER = "./src/test/resources/IndiaStateCodeWrongHeader.csv";
    private static final String STATE_CODE_CSV_FILE_PATH_WITH_WRONG_DELIMETRE = "./src/test/resources/StateCodeWrongDelimetre.csv";
    ...
    public void givenIndiaCensusData_WithIncorrectDelimiter_ShouldThrowException() {
        try {
            ...
            ExpectedException exceptionRule = ExpectedException.none();
            exceptionRule.expect(CensusAnalyserException.class);
            censusAnalyser.loadIndiaCensusData(INDIA_CENSUS_CSV_FILE_PATH_WITH_WRONG_DELIMETRE);
        } catch (CensusAnalyserException e) {
            System.out.println(e.getMessage());
    ...
    public void givenIndianCensusData_WithWrongHeader_ShouldThrowException() {
        try {
            ...
            ExpectedException exceptionRule = ExpectedException.none();
            exceptionRule.expect(CensusAnalyserException.class);
            censusAnalyser.loadIndiaCensusData(INDIA_CENSUS_CSV_FILE_PATH_WITH_WRONG_HEADER);
        } catch (CensusAnalyserException e) {
            System.out.println(e.getMessage());
